    ...
    <Paddle top={32} left={24} right={24}>
      <Col align="center" gap={32}>
        <Col align="center" gap={12}>
          ...
          <Text label="우리 팅의 미팅 목적은..." font="LeferiBaseType-RegularA" />
        </Col>
        {/* src 채워야함 */}
        <Image width={300} height={240} alt="" src={'/몰?루'} />
        <Col gap={12}>
          <Button label="친구를 만들고 싶어요!" primary="inactive" textSize="sm" />
          <Button label="연인을 만들고 싶어요!" primary="inactive" textSize="sm" />
